...
// import 'package:assingmentapp/pages/product_detail_page.dart';
...
//     // Scroll listener to detect when to load more
...
//                 onTap: () async {
//                   // Wait for the Cart Page to return
...
//                     ),
//                   );
//                   // Update the UI after returning from CartPage
//                   setState(() {});
//                 },
//                 child: badges.Badge(
...
//                   badgeContent: Text(
//                     cart.length
//                         .toString(), // Ensure updated cart length is displayed
...
//               ),
//         bottomNavigationBar:
//             BottomBarWidget(cardPageNavigator: CartPage(cart: cart)));
//   }
// }
